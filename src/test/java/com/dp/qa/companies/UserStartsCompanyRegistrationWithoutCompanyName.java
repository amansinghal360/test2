...
public class UserStartsCompanyRegistrationWithoutCompanyName extends TestBase {
	...
	@Test(description = "How a user would begin the process of registering a new company or associating to an existing company when they did not specify a company name during user registration")
	public void userStartsCompanyRegistrationWithoutCompanyName() {
